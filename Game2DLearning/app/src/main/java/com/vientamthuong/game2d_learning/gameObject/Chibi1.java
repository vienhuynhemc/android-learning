...
public class Chibi1 extends GameObject {
    ...
    public Chibi1(int x, int y, int width, int height, GameSurface gameSurface) {
        super(x, y, width, height, gameSurface);
        this.gameSurface = gameSurface;
        leftToRight = gameSurface.getLoadAnimation().getListAnimation().get("chibi1_right");
        rightToLeft = gameSurface.getLoadAnimation().getListAnimation().get("chibi1_left");
        topToBottom = gameSurface.getLoadAnimation().getListAnimation().get("chibi1_bottom");
        bottomToTop = gameSurface.getLoadAnimation().getListAnimation().get("chibi1_top");
